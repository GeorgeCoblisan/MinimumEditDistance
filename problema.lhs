...
minDistance:: [Char] -> [Int]
minDistance [] = []
minDistance s = find dictionary s
    where dictionary = ["saturday", "monday", "tuesday", "nonday"]

minFinal:: [Char] -> [[Char]]
minFinal s = findWord dictionary minList minNumber
    where 
        dictionary = ["saturday", "monday", "tuesday", "nonday"]
        minList = minDistance s
...
minDistance2:: [Char] -> [Int]
minDistance2 [] = []
minDistance2 s = find2 dictionary s
    where dictionary = ["saturday", "monday", "tuesday", "nonday"]

minFinal2:: [Char] -> [[Char]]
minFinal2 s = findWord dictionary minList minNumber
    where 
        dictionary = ["saturday", "monday", "tuesday", "nonday"]
        minList = minDistance2 s
        minNumber = minim minList
